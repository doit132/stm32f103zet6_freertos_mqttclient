 ...
 *         The function @ref HAL_FLASH_Unlock() should be called before to unlock the FLASH
 * interface The function @ref HAL_FLASH_OB_Unlock() should be called before to unlock the options
 * bytes The function @ref HAL_FLASH_OB_Launch() should be called after to force the reload of the
 ...
 * @note   The function @ref HAL_FLASH_Unlock() should be called before to unlock the FLASH
 * interface The function @ref HAL_FLASH_OB_Unlock() should be called before to unlock the options
 * bytes The function @ref HAL_FLASH_OB_Launch() should be called after to force the reload of the
 * options bytes (system reset will occur)
 *
 ...
 * interface The function @ref HAL_FLASH_OB_Unlock() should be called before to unlock the options
 * bytes The function @ref HAL_FLASH_OB_Launch() should be called after to force the reload of the
 * options bytes (system reset will occur) Programming of the OB should be performed only after an
 * erase (otherwise PGERR occurs)
