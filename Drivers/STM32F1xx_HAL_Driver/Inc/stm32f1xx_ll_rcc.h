...
typedef struct {
	...
	#define LL_RCC_MCO1SOURCE_PLLCLK_DIV_2 \
		...
		#define LL_RCC_MCO1SOURCE_EXT_HSE \
			RCC_CFGR_MCO_EXT_HSE /*!< XT1 external 3-25 MHz oscillator clock selected \
						as MCO source */
	...
	#define LL_RCC_PLLSOURCE_HSE \
		...
		#define LL_RCC_PLLSOURCE_PLL2 \
			(RCC_CFGR_PLLSRC | RCC_CFGR2_PREDIV1SRC \
						   << 4U) /*!< PLL2/PREDIV1 clock selected as PLL \
							     entry clock source */
	#endif						  /*RCC_CFGR2_PREDIV1SRC*/

	#if defined(RCC_CFGR2_PREDIV1)
		#define LL_RCC_PLLSOURCE_HSE_DIV_1 \
			(RCC_CFGR_PLLSRC | RCC_CFGR2_PREDIV1_DIV1) /*!< HSE/1 clock selected as \
								      PLL entry clock source */
		#define LL_RCC_PLLSOURCE_HSE_DIV_2 \
			(RCC_CFGR_PLLSRC | RCC_CFGR2_PREDIV1_DIV2) /*!< HSE/2 clock selected as \
								      PLL entry clock source */
		#define LL_RCC_PLLSOURCE_HSE_DIV_3 \
			(RCC_CFGR_PLLSRC | RCC_CFGR2_PREDIV1_DIV3) /*!< HSE/3 clock selected as \
								      PLL entry clock source */
		#define LL_RCC_PLLSOURCE_HSE_DIV_4 \
			(RCC_CFGR_PLLSRC | RCC_CFGR2_PREDIV1_DIV4) /*!< HSE/4 clock selected as \
								      PLL entry clock source */
		#define LL_RCC_PLLSOURCE_HSE_DIV_5 \
			(RCC_CFGR_PLLSRC | RCC_CFGR2_PREDIV1_DIV5) /*!< HSE/5 clock selected as \
								      PLL entry clock source */
		#define LL_RCC_PLLSOURCE_HSE_DIV_6 \
			(RCC_CFGR_PLLSRC | RCC_CFGR2_PREDIV1_DIV6) /*!< HSE/6 clock selected as \
								      PLL entry clock source */
		#define LL_RCC_PLLSOURCE_HSE_DIV_7 \
			(RCC_CFGR_PLLSRC | RCC_CFGR2_PREDIV1_DIV7) /*!< HSE/7 clock selected as \
								      PLL entry clock source */
		#define LL_RCC_PLLSOURCE_HSE_DIV_8 \
			(RCC_CFGR_PLLSRC | RCC_CFGR2_PREDIV1_DIV8) /*!< HSE/8 clock selected as \
								      PLL entry clock source */
		#define LL_RCC_PLLSOURCE_HSE_DIV_9 \
			(RCC_CFGR_PLLSRC | RCC_CFGR2_PREDIV1_DIV9) /*!< HSE/9 clock selected as \
								      PLL entry clock source */
	 ...
	 */
		 ...
		 * @param  __INPUTFREQ__ PLL Input frequency (based on HSE div Prediv1 / HSI div 2 /
		 * PLL2 div Prediv1)
