...
typedef struct {
	...
	#define LL_GPIO_PIN_ALL \
		(LL_GPIO_PIN_0 | LL_GPIO_PIN_1 | LL_GPIO_PIN_2 | LL_GPIO_PIN_3 | LL_GPIO_PIN_4 | \
		 ...
		 LL_GPIO_PIN_14 | LL_GPIO_PIN_15) /*!< Select all pins */
	/**
	 * @}
	 */
 ...
 * @note   I/O mode can be Analog, Floating input, Input with pull-up/pull-down, General purpose
 * Output, Alternate function Output.
...
/**
 * @brief Enable or disable the remapping of CAN alternate function CAN_RX and CAN_TX in devices
 * with a single CAN interface.
...
/**
 * @brief Enable the remapping of SPI3 alternate functions SPI3_NSS/I2S3_WS, SPI3_SCK/I2S3_CK,
 * SPI3_MISO, SPI3_MOSI/I2S3_SD.
...
/**
 * @brief Disable the remapping of SPI3 alternate functions SPI3_NSS/I2S3_WS, SPI3_SCK/I2S3_CK,
 * SPI3_MISO, SPI3_MOSI/I2S3_SD.
 ...
 * @note  ENABLE: DMA2 channel 5 interrupt is mapped separately at position 60 and TIM15 TRGO event
 * is selected as DAC Trigger 3, TIM15 triggers TIM1/3.
 * @note  This bit is available only in high density value line devices.
 * @retval None
 */
...
void LL_GPIO_StructInit(LL_GPIO_InitTypeDef *GPIO_InitStruct);
	 ...
	 */
	  ...
	  (GPIOE) || defined (GPIOF) || defined (GPIOG) */
/**
 * @}
 */
