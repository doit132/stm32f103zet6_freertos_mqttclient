...
/* Interrupt & Flag management */
	...
	defined(STM32F107xC)
	/** @defgroup DMAEx_High_density_XL_density_Product_devices DMAEx High density and XL
	 * density product devices
	 * @{
	 */
	 ...
	 *         Where x can be 1_7 or 1_5 (depending on DMA1 or DMA2) to select the DMA Channel
	 * flag.
...
#else
	/** @defgroup DMA_Low_density_Medium_density_Product_devices DMA Low density and Medium
	 * density product devices
	 * @{
	 */
