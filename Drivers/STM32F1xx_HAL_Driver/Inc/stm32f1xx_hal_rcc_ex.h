 ...
 */
	...
	#define RCC_CR_PLLI2SON_BB \
		((uint32_t)(PERIPH_BB_BASE + (RCC_CR_OFFSET_BB * 32U) + (PLLI2SON_BITNUMBER * 4U)))
	/* Alias word address of PLL2ON bit */
	#define PLL2ON_BITNUMBER RCC_CR_PLL2ON_Pos
	#define RCC_CR_PLL2ON_BB \
		((uint32_t)(PERIPH_BB_BASE + (RCC_CR_OFFSET_BB * 32U) + (PLL2ON_BITNUMBER * 4U)))
...
typedef struct {
	...
	uint32_t
		PLL2MUL; /*!< PLL2MUL: Multiplication factor for PLL2 VCO input clock
...
typedef struct {
	...
	uint32_t
		I2s2ClockSelection; /*!< I2S2 clock source
				    This parameter can be a value of @ref RCCEx_I2S2_Clock_Source */

	uint32_t
		I2s3ClockSelection; /*!< I2S3 clock source
...
#endif /* STM32F101xE || STM32F103xE || STM32F101xG || STM32F103xG || STM32F105xC || STM32F107xC \
	  || STM32F100xE */
...
#endif /* STM32F101xG || STM32F103x6 || STM32F103xB || STM32F105xC || STM32F107xC || STM32F103xE \
	  || STM32F103xG */
 ...
 */
	 ...
	 *         In this case, you have to select another source of the system clock, disable the
	 * PLL and then change the HSE predivision factor.
 ...
 */
	 ...
	 *            @arg @ref RCC_USBCLKSOURCE_PLL_DIV1_5 PLL clock divided by 1.5 selected as USB
	 * clock
	 */
	...
	*/
	 ...
	 * @param  __USBCLKSOURCE__ specifies the USB clock source.
	 *          This parameter can be one of the following values:
	 *            @arg @ref RCC_USBCLKSOURCE_PLL_DIV2 PLL clock divided by 2 selected as USB OTG
	 * FS clock
	 *            @arg @ref RCC_USBCLKSOURCE_PLL_DIV3 PLL clock divided by 3 selected as USB OTG
	 * FS clock
	 */
	#define __HAL_RCC_USB_CONFIG(__USBCLKSOURCE__) \
 ...
 */
	 ...
	 *         In this case, you have to select another source of the system clock, disable the
	 * PLL2 and PLLI2S and then change the PREDIV2 factor.
	 * @param  __HSE_PREDIV2_VALUE__ specifies the PREDIV2 value applied to PLL2 & PLLI2S.
	 *         This parameter must be a number between RCC_HSE_PREDIV2_DIV1 and
	 ...
	 *            @arg @ref RCC_I2S2CLKSOURCE_PLLI2S_VCO PLLI2S VCO clock selected as I2S3 clock
	 * entry
	 */
	 ...
	 *            @arg @ref RCC_I2S3CLKSOURCE_PLLI2S_VCO PLLI2S VCO clock selected as I2S3 clock
	 * entry
	 */
