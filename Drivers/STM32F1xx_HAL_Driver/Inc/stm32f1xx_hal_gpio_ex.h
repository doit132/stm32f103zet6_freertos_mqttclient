...
#define IS_AFIO_EVENTOUT_PIN(__PIN__) \
	(((__PIN__) == AFIO_EVENTOUT_PIN_0) || ((__PIN__) == AFIO_EVENTOUT_PIN_1) || \
	 ...
	 ((__PIN__) == AFIO_EVENTOUT_PIN_10) || ((__PIN__) == AFIO_EVENTOUT_PIN_11) || \
	 ((__PIN__) == AFIO_EVENTOUT_PIN_12) || ((__PIN__) == AFIO_EVENTOUT_PIN_13) || \
...
/**
 * @brief Enable the remapping of TIM1 alternate function channels 1 to 4, 1N to 3N, external
 * trigger (ETR) and Break input (BKIN)
 * @note  ENABLE: Full remap     (ETR/PE7,  CH1/PE9, CH2/PE11, CH3/PE13, CH4/PE14, BKIN/PE15,
 ...
 * @brief Enable the remapping of TIM1 alternate function channels 1 to 4, 1N to 3N, external
 * trigger (ETR) and Break input (BKIN)
 * @note  PARTIAL: Partial remap (ETR/PA12, CH1/PA8, CH2/PA9,  CH3/PA10, CH4/PA11, BKIN/PA6,
...
/**
 * @brief Disable the remapping of TIM1 alternate function channels 1 to 4, 1N to 3N, external
 * trigger (ETR) and Break input (BKIN)
 * @note  DISABLE: No remap      (ETR/PA12, CH1/PA8, CH2/PA9,  CH3/PA10, CH4/PA11, BKIN/PB12,
 * CH1N/PB13, CH2N/PB14, CH3N/PB15)
 * @retval None
 */
#define __HAL_AFIO_REMAP_TIM1_DISABLE() \
	AFIO_REMAP_PARTIAL(AFIO_MAPR_TIM1_REMAP_NOREMAP, AFIO_MAPR_TIM1_REMAP_FULLREMAP)
...
/**
 * @brief Disable the remapping of TIM2 alternate function channels 1 to 4 and external trigger
 * (ETR)
 * @note  DISABLE: No remap        (CH1/ETR/PA0,  CH2/PA1, CH3/PA2,  CH4/PA3)
 * @retval None
 */
#define __HAL_AFIO_REMAP_TIM2_DISABLE() \
	AFIO_REMAP_PARTIAL(AFIO_MAPR_TIM2_REMAP_NOREMAP, AFIO_MAPR_TIM2_REMAP_FULLREMAP)
...
#define __HAL_AFIO_REMAP_TIM3_DISABLE() \
	AFIO_REMAP_PARTIAL(AFIO_MAPR_TIM3_REMAP_NOREMAP, AFIO_MAPR_TIM3_REMAP_FULLREMAP)
...
#define __HAL_AFIO_REMAP_TIM4_DISABLE() AFIO_REMAP_DISABLE(AFIO_MAPR_TIM4_REMAP)
	...
	/**
	 * @brief Enable or disable the remapping of CAN alternate function CAN_RX and CAN_TX in
	 ...
	 * @brief Enable or disable the remapping of CAN alternate function CAN_RX and CAN_TX in
	 * devices with a single CAN interface.
	 * @note  CASE 2: CAN_RX mapped to PB8,  CAN_TX mapped to PB9 (not available on 36-pin
	 * package)
	 * @retval None
	 */
...
#define __HAL_AFIO_REMAP_SWJ_DISABLE()	AFIO_DBGAFR_CONFIG(AFIO_MAPR_SWJ_CFG_DISABLE)
	 ...
	 * @note  ENABLE: Remap     (SPI3_NSS-I2S3_WS/PA4,  SPI3_SCK-I2S3_CK/PC10, SPI3_MISO/PC11,
	 ...
	 * SPI3_SCK/I2S3_CK, SPI3_MISO, SPI3_MOSI/I2S3_SD.
	 * @note  DISABLE: No remap (SPI3_NSS-I2S3_WS/PA15, SPI3_SCK-I2S3_CK/PB3,  SPI3_MISO/PB4,
	 ...
	 * @note  TO_USB: Connect USB OTG SOF (Start of Frame) output to TIM2_ITR1 for calibration
	 * purposes.
	 * @note  This bit is available only in connectivity line devices and is reserved otherwise.
	 * @retval None
	 */
	...
	/**
	 * @brief Control of TIM2_ITR1 internal mapping.
	 * @note  TO_ETH: Connect TIM2_ITR1 internally to the Ethernet PTP output for calibration
	 * purposes.
	 * @note  This bit is available only in connectivity line devices and is reserved otherwise.
	 * @retval None
	 */
	 ...
	 * @note  DISCONNECTED: The NADV signal is not connected. The I/O pin can be used by another
	 * peripheral.
	 * @retval None
	 */
	 ...
	 * @note  ENABLE: Remap (TIM1_CH1 DMA request/DMA1 Channel6, TIM1_CH2 DMA request/DMA1
	 * Channel6)
	 * @retval None
	 */
	...
	/**
	 * @brief Controls the mapping of the TIM1_CH1 TIM1_CH2 DMA requests onto the DMA1 channels.
	 * @note  DISABLE: No remap (TIM1_CH1 DMA request/DMA1 Channel2, TIM1_CH2 DMA request/DMA1
	 * Channel3).
	 * @retval None
	 */
	...
	/**
	 * @brief Controls the mapping of the TIM6_DAC1 and TIM7_DAC2 DMA requests onto the DMA1
	 * channels.
	 * @note  ENABLE: Remap (TIM6_DAC1 DMA request/DMA1 Channel3, TIM7_DAC2 DMA request/DMA1
	 * Channel4)
	 * @retval None
	 */
	 ...
	 * @brief Controls the mapping of the TIM6_DAC1 and TIM7_DAC2 DMA requests onto the DMA1
	 * channels.
	 * @note  DISABLE: No remap (TIM6_DAC1 DMA request/DMA2 Channel3, TIM7_DAC2 DMA request/DMA2
	 * Channel4)
	 * @retval None
	 */
	 ...
	 *        The timer selection for DAC trigger 3 (TSEL[2:0] = 011, for more details refer to
	 * the DAC_CR register).
	 * @note  ENABLE: DMA2 channel 5 interrupt is mapped separately at position 60 and TIM15
	 * TRGO event is selected as DAC Trigger 3, TIM15 triggers TIM1/3.
	 * @note  This bit is available only in high density value line devices.
	 * @retval None
	 */
	 ...
	 *        The timer selection for DAC trigger 3 (TSEL[2:0] = 011, for more details refer to
	 * the DAC_CR register).
	 * @note  DISABLE: DMA2 channel 5 interrupt is mapped with DMA2 channel 4 at position 59,
	 * TIM5 TRGO event is selected as DAC Trigger 3, TIM5 triggers TIM1/3.
	 * @note  This bit is available only in high density value line devices.
	 * @retval None
	 */
