 ...
 */
	...
	#define LL_MPU_CTRL_HARDFAULT_NMI \
		MPU_CTRL_HFNMIENA_Msk /*!< Enables the operation of MPU during hard fault, NMI, \
					 and FAULTMASK handlers */
	#define LL_MPU_CTRL_PRIVILEGED_DEFAULT \
		MPU_CTRL_PRIVDEFENA_Msk /*!< Enable privileged software access to default memory \
					   map */
	...
	#define LL_MPU_REGION_PRIV_RW_URO \
		(0x02U << MPU_RASR_AP_Pos) /*!< RW privileged - RO user (Write in a user program \
					      generates a fault) */
