...
typedef struct {
	...
	uint32_t PageAddress; /*!< PageAdress: Initial FLASH page address to erase when mass erase
				 is disabled This parameter must be a number between Min_Data =
				 0x08000000 and Max_Data = FLASH_BANKx_END (x = 1 or 2 depending on
				 devices)*/

	uint32_t NbPages; /*!< NbPages: Number of pagess to be erased.
			       This parameter must be a value between Min_Data = 1 and Max_Data =
			     (max number of pages - value of initial page)*/
...
typedef struct {
	...
	uint8_t USERConfig; /*!< USERConfig: Program the FLASH User Option Byte:
				 ...
				 This parameter can be a combination of @ref FLASHEx_OB_IWatchdog,
			       @ref FLASHEx_OB_nRST_STOP,
...
#if (defined(STM32F100xE) || defined(STM32F101xE) || defined(STM32F103xE) || \
     defined(STM32F101xG) || defined(STM32F103xG) || defined(STM32F105xC) || defined(STM32F107xC))
