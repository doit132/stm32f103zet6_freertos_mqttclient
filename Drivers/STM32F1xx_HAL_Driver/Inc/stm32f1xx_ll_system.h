 ...
 */
	...
	#define LL_DBGMCU_TRACE_SYNCH_SIZE1 \
		(DBGMCU_CR_TRACE_IOEN | \
		 DBGMCU_CR_TRACE_MODE_0) /*!< TRACE pin assignment for Synchronous Mode with a \
					    TRACEDATA size of 1 */
	#define LL_DBGMCU_TRACE_SYNCH_SIZE2 \
		(DBGMCU_CR_TRACE_IOEN | \
		 DBGMCU_CR_TRACE_MODE_1) /*!< TRACE pin assignment for Synchronous Mode with a \
					    TRACEDATA size of 2 */
	...
	#define LL_DBGMCU_APB1_GRP1_I2C1_STOP \
		DBGMCU_CR_DBG_I2C1_SMBUS_TIMEOUT /*!< I2C1 SMBUS timeout mode stopped when Core is \
						    halted */
...
/**
  ...
  * @note This field indicates the revision of the device.
	  ...
	  For example, it is read as revA -> 0x0000, revB -> 0x2000, revZ -> 0x2001, rev1,2,3,X or Y
  -> 0x2003,for Medium Density devices For example, it is read as revA or 1 -> 0x1000, revZ ->
  0x1001,rev1,2,3,X or Y -> 0x1003,for Medium Density devices For example, it is read as revA or 1
  -> 0x1003,for XL Density devices For example, it is read as revA -> 0x1000, revZ -> 0x1001 for
