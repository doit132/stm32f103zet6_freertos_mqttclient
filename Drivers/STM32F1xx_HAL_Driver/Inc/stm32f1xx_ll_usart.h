...
typedef struct {
	...
	uint32_t DataWidth; /*!< Specifies the number of data bits transmitted or received in a
			       frame. This parameter can be a value of @ref USART_LL_EC_DATAWIDTH.
	...
	uint32_t TransferDirection; /*!< Specifies whether the Receive and/or Transmit mode is
	...
	uint32_t HardwareFlowControl; /*!< Specifies whether the hardware flow control mode is
					 enabled or disabled. This parameter can be a value of @ref
...
typedef struct {
	...
	uint32_t ClockPolarity; /*!< Specifies the steady state of the serial clock.
				     ...
				     USART HW configuration can be modified afterwards using unitary
				   functions @ref LL_USART_SetClockPolarity(). For more details,
	...
	uint32_t ClockPhase; /*!< Specifies the clock transition on which the bit capture is made.
				  ...
				  USART HW configuration can be modified afterwards using unitary
				functions @ref LL_USART_SetClockPhase(). For more details, refer to
				description of this function. */

	uint32_t LastBitClockPulse; /*!< Specifies whether the clock pulse corresponding to the last
				       transmitted data bit (MSB) has to be output on the SCLK pin
				       in synchronous mode. This parameter can be a value of @ref
				       USART_LL_EC_LASTCLKPULSE.

					 USART HW configuration can be modified afterwards using
				       unitary functions @ref LL_USART_SetLastClkPulseOutput(). For
				       more details, refer to description of this function. */
	...
	#define LL_USART_LASTCLKPULSE_NO_OUTPUT \
		0x00000000U /*!< The clock pulse of the last data bit is not output to the SCLK \
			       pin */
 ...
 * status flags, in the USARTx_SR are set to their default values.
 ...
 * framing error, overrun error or noise flag (FE=1 or ORE=1 or NF=1 in the USARTx_SR register). 0:
 * Interrupt is inhibited 1: An interrupt is generated when FE=1 or ORE=1 or NF=1 in the USARTx_SR
 * register.
