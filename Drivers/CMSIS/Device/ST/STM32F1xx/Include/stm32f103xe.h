...
typedef struct {
	__IO uint32_t SR;  /*!< ADC status register,    used for ADC multimode (bits common to
			      several ADC instances). Address offset: ADC1 base address         */
	__IO uint32_t CR1; /*!< ADC control register 1, used for ADC multimode (bits common to
			      several ADC instances). Address offset: ADC1 base address + 0x04  */
	__IO uint32_t CR2; /*!< ADC control register 2, used for ADC multimode (bits common to
			      several ADC instances). Address offset: ADC1 base address + 0x08  */
	uint32_t RESERVED[16];
	__IO uint32_t DR; /*!< ADC data register,      used for ADC multimode (bits common to
...
typedef struct {
	...
	uint16_t
		RESERVED1; /*!< Reserved,                                    Address offset: 0x06 */
...
#define AFIO_MAPR_TIM2_REMAP_FULLREMAP \
	AFIO_MAPR_TIM2_REMAP_FULLREMAP_Msk /*!< Full remap (CH1/ETR/PA15, CH2/PB3, CH3/PB10, \
					      CH4/PB11) */
...
#define AFIO_MAPR_TIM3_REMAP_PARTIALREMAP \
	AFIO_MAPR_TIM3_REMAP_PARTIALREMAP_Msk /*!< Partial remap (CH1/PB4, CH2/PB5, CH3/PB0, \
						 CH4/PB1) */
...
#define FSMC_BWTRx_BUSTURN \
	FSMC_BWTRx_BUSTURN_Msk /*!< BUSTURN[3:0] bits (Bus turnaround phase duration) */
...
#define FSMC_PMEMx_MEMHIZx \
	FSMC_PMEMx_MEMHIZx_Msk /*!< MEMHIZx[7:0] bits (Common memory x databus HiZ time) */
...
#define FSMC_PATTx_ATTSETx \
	FSMC_PATTx_ATTSETx_Msk /*!< ATTSETx[7:0] bits (Attribute memory x setup time) */
...
#define FSMC_PATTx_ATTWAITx \
	FSMC_PATTx_ATTWAITx_Msk /*!< ATTWAITx[7:0] bits (Attribute memory x wait time) */
...
#define FSMC_PATTx_ATTHOLDx \
	FSMC_PATTx_ATTHOLDx_Msk /*!< ATTHOLDx[7:0] bits (Attribute memory x hold time) */
...
#define FSMC_PATTx_ATTHIZx \
	FSMC_PATTx_ATTHIZx_Msk /*!< ATTHIZx[7:0] bits (Attribute memory x databus HiZ time) */
...
#define SDIO_FIFOCNT_FIFOCOUNT \
	SDIO_FIFOCNT_FIFOCOUNT_Msk /*!< Remaining number of words to be written to or read from \
				      the FIFO */
