...
typedef struct {
	...
	*/
	 ...
	 */
			...
			/*#define NVIC_GetActive              __NVIC_GetActive             not
			 * available for SC000 */
...
{
	if ((int32_t)(IRQn) >= 0) {
		return ((uint32_t)(((NVIC->ISER[0U] & (1UL << (((uint32_t)IRQn) & 0x1FUL))) != 0UL)
					   ? 1UL
					   : 0UL));
	} else {
		return (0U);
...
{
	if ((int32_t)(IRQn) >= 0) {
		return ((uint32_t)(((NVIC->ISPR[0U] & (1UL << (((uint32_t)IRQn) & 0x1FUL))) != 0UL)
					   ? 1UL
					   : 0UL));
	} else {
		return (0U);
