...
typedef enum {
	...
	osErrorNoMemory = -5, ///< System is out of memory: it was impossible to allocate or reserve
			      ///< memory for the operation.
	osErrorISR = -6,      ///< Not allowed in ISR context: the function cannot be called from
...
/// behavior. \param[in]     argument      argument to the timer callback function. \param[in] attr
/// timer attributes; NULL: default values. \return timer ID for reference by other functions or
